      ...
      <div className="bg-card/80 backdrop-blur-xl border border-border/50 rounded-2xl p-8 shadow-2xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <Button
            ...
            className="w-full h-12 text-base font-semibold bg-gradient-to-r from-primary to-accent hover:from-primary/90 hover:to-accent/90 shadow-lg shadow-primary/25 transition-all duration-300"
          >
            {isLoading ? (
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
            <div className="bg-card p-6 rounded-xl max-w-lg w-full relative">
              ...
              <div className="max-h-80 overflow-y-auto space-y-2 text-sm">
                ...
                <p>
                  Xyfen provides a tool for personal use. You agree to use the Service only for
                  lawful purposes.
                </p>
              </div>
            </div>
